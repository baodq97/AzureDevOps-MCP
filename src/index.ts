...
async function main() {
  try {
    ...
    allowedTools.has('getWorkItemById') &&
      server.tool(
        'getWorkItemById',
    ...
    allowedTools.has('updateWorkItem') &&
      server.tool(
        'updateWorkItem',
    ...
    allowedTools.has('addWorkItemComment') &&
      server.tool(
        'addWorkItemComment',
    ...
    allowedTools.has('updateWorkItemState') &&
      server.tool(
        'updateWorkItemState',
    ...
    allowedTools.has('assignWorkItem') &&
      server.tool(
        'assignWorkItem',
    ...
    allowedTools.has('bulkCreateWorkItems') &&
      server.tool(
        'bulkCreateWorkItems',
